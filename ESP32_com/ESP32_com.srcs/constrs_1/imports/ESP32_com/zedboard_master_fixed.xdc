...
set_property PACKAGE_PIN AA11 [get_ports {ESP_RX}];  # "JA2" RX
set_property PACKAGE_PIN Y10  [get_ports {ESP_TX}];  # "JA3" TX
#set_property IOSTANDARD LVCMOS33 AA11 [get_ports {ESP_RX}];  # "JA2" RX
#set_property IOSTANDARD LVCMOS33 Y10  [get_ports {ESP_TX}];  # "JA3" TX
